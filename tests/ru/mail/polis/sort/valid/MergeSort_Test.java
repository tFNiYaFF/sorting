...
public class MergeSort_Test {
    ...
    public void test01_checkMergeSort() throws IOException {
        ...
        Assert.assertTrue(isSorted(MergeSort.sort(array, new int[right+1],0, right)));
    }

    @Test
    public void test02_checkMergeSortPlus() throws IOException {
        Assert.assertTrue(isSorted(MergeSortPlus.sort(array)));
    }
